...
import com.example.hello.entity.Book;
import com.example.hello.entity.Reader;
import com.example.hello.entity.borrow_record;
import com.example.hello.util.Constant;
 ...
 * @date 2020/8/5 13:35
 */
public class FxReaderController implements Initializable {
    ...
    public void setUserInfo(String id) {
        ...
        if (reader != null) {
            ...
            welcomeLabel.setText(reader.getName() + " ，您好！");
